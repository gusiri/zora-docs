...
- Specify network type to `goerli`
```
query TokenEvents {
  token(
    token: {address: "0x80cE590A9F050b6022a4FF3bA6bb350D22A44889", tokenId: "1"}
...
query TokenEvents {
  token(
    token: {address: "0xf52Ffb0286dcc24e800dF306f7835a439C0c6EDa", tokenId: "1"}
...
#https://goerli.etherscan.io/address/0xcc4eef05f36318bfc837efc85ae68b197053965e
```
